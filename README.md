...
* 🧠 **Focusing on:** AI & ML Wizardry, Full-Stack Web Development, and Data Structures & Algorithms.
...
| :--- | :--- | :--- |
| 🧬 **[Drugoo](https://github.com/Sujal0910/drugoo)** | Full-stack precision medicine application acts as a digital clinical geneticist. | `Full-Stack` |
...
| 💬 **[AndromedaChatbot](https://github.com/Sujal0910/AndromedaChatbot)** | Interactive AI chatbot designed for responsive user queries. | `HTML`, `Python` |
| 📊 **[review-analyzer](https://github.com/Sujal0910/review-analyzer)** | Sentiment analysis tool to parse and evaluate reviews. | `Python` |
| ❤️ **[tinder-clone](https://github.com/Sujal0910/tinder-clone)** | A functional Tinder clone built for educational purposes. | `JavaScript` |
